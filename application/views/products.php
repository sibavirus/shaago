				...
				<div class="panel-body">
					...
					<div class="row" style="margin-bottom: 5px;">
						<div class="col-md-12" style="text-align: right;">
							<a href="<?=base_url()?>products/exportProductsReport" style="text-decoration: none">
							...
							<table class="table">
							    <thead>
							    	<tr>
								    	...
								    	<th width="10%"><?php echo $lang_profit_margin; ?></th>
                                    ...
                                    if (count($results) > 0) {
                                        foreach ($results as $data) {
											...
											<tr>
												...
												<td><?php echo number_format(($price-$cost), 2); ?></td>
