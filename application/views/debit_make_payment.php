								...
								<div class="col-md-8" style="border-top: 1px solid #000;">
									...
									<div class="row" id="cheque_wrp" style="padding-top: 15px; padding-bottom: 10px;">
										...
										<div class="col-md-6">
											...
											<input type="hidden" name="unpaidAmt" id="unpaidAmt" value="<?php echo abs($unpaid_amt); ?>" />
											<button type="submit" class="btn btn-primary" id="subBtn"><?php echo $lang_submit_payment; ?></button>
										</div>
									</div>
