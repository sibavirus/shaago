				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown"><svg class="glyph stroked male-user">
							...
							</svg> <?php echo $login_name; ?> <span class="caret"></span></a>
	...
	?>
		<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
			<ul class="nav menu">
				...
				if ($user_role < 3) {
				?>
					<li <?php if ($tk_c == 'reports') { ?> class="parent active" <?php } else {
																					echo 'class="parent"';
																				} ?>>
						<a data-toggle="collapse" href="#sub-item-reports">
							<?php echo $lang_reports; ?>
						</a>
						<ul class="children <?php if ($tk_c != 'reports') { ?> collapse <?php } ?>" id="sub-item-reports">
							<li>
								<a <?php if (($tk_m == 'sales_report')) { ?> style="background-color: #e9ecf2;" <?php } ?> href="<?= base_url() ?>reports/sales_report">
									<?php echo $lang_sales_report; ?>
								</a>
							</li>

							<li>
								<a <?php if (($tk_m == 'sold_by_products')) { ?> style="background-color: #e9ecf2;" <?php } ?> href="<?= base_url() ?>reports/sold_by_products">
									<?php echo $this->lang->line("sold_by_product_report"); ?>
								</a>
							</li>

							<li>
								<a <?php if (($tk_m == 'product_margin')) { ?> style="background-color: #e9ecf2;" <?php } ?> href="<?= base_url() ?>reports/product_margin">
									<?php echo $this->lang->line("product_margin"); ?>
								</a>
							</li>

							<li>
								<a <?php if (($tk_m == 'outlet_report')) { ?> style="background-color: #e9ecf2;" <?php } ?> href="<?= base_url() ?>reports/outlet_report">
									<?php echo $this->lang->line("outlet_report"); ?>
								</a>
							</li>
						</ul>
					</li>
